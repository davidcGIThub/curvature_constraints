...
def find_max_curvature_root_finder(control_points,order,M):
    ...
    curvature_start = calculate_curvature(0,M,control_points,order)
    curvature_end = calculate_curvature(1,M,control_points,order)
    ...
    for i in range(num_intervals):
        try:
            ...
            root = solution.root
            curvature = calculate_curvature(root,M,control_points,order)
