...
def get_control_point_curvature_bound(control_points,order,scale_factor=1,method="mdm"):
    ...
    if method == "rotate":
        min_velocity = get_min_velocity_rotation_method(control_point_velocities)
...
def get_min_velocity_rotation_method(control_point_velocities):
