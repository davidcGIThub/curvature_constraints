...
TEST(BsplineToBezierTests, 2DFirstOrderConversion)
{
    ...
    bezier_control_points << BsplineToBezier::convert_2D_first_order_spline(bspline_control_points);
...
TEST(BsplineToBezierTests, 2DThirdOrderConversion)
{
    ...
    bezier_control_points << BsplineToBezier::convert_2D_third_order_spline(bspline_control_points);
...
TEST(BsplineToBezierTests, 2DFourthOrderConversion)
{
    ...
    bezier_control_points << BsplineToBezier::convert_2D_fourth_order_spline(bspline_control_points);
    float tolerance = 0.00000001;
    EXPECT_TRUE(bezier_control_points.isApprox(true_bezier_control_points,tolerance));
}
...
TEST(BsplineToBezierTests, 2DFifthOrderConversion)
{
    ...
    bezier_control_points << BsplineToBezier::convert_2D_fifth_order_spline(bspline_control_points);
    float tolerance = 0.00000001;
    EXPECT_TRUE(bezier_control_points.isApprox(true_bezier_control_points,tolerance));
}
...
TEST(BsplineToBezierTests, 3DFirstOrderConversion)
{
    ...
    bezier_control_points << BsplineToBezier::convert_3D_first_order_spline(bspline_control_points);
    float tolerance = 0.00000001;
    EXPECT_TRUE(bezier_control_points.isApprox(true_bezier_control_points,tolerance));
}
...
TEST(BsplineToBezierTests, 3DThirdOrderConversion)
{
    ...
    bezier_control_points << BsplineToBezier::convert_3D_third_order_spline(bspline_control_points);
    float tolerance = 0.00000001;
    EXPECT_TRUE(bezier_control_points.isApprox(true_bezier_control_points,tolerance));
}
...
TEST(BsplineToBezierTests, 3DFourthOrderConversion)
{
    ...
    bezier_control_points << BsplineToBezier::convert_3D_fourth_order_spline(bspline_control_points);
...
TEST(BsplineToBezierTests, 3DFifthOrderConversion)
{
    ...
    bezier_control_points << BsplineToBezier::convert_3D_fifth_order_spline(bspline_control_points);
    float tolerance = 0.00000001;
    EXPECT_TRUE(bezier_control_points.isApprox(true_bezier_control_points,tolerance));
}
