...
template <int D>
float ThirdOrderCurvatureBounds<D>::get_spline_curvature_bound(float cont_pts[], int &num_control_points)
{
...
template <int D>
Eigen::VectorXf ThirdOrderCurvatureBounds<D>::get_interval_curvature_bounds(float cont_pts[], int &num_control_points)
{
    int order = 3;
...
template <int D>
float ThirdOrderCurvatureBounds<D>::evaluate_interval_curvature_bound(Eigen::Matrix<float,D,4> &control_points)
{
...
template <int D>
float ThirdOrderCurvatureBounds<D>::find_maximum_cross_term(Eigen::Matrix<float,D,4> &control_points, float &scale_factor)
{
...
template <int D>
Eigen::Vector4d ThirdOrderCurvatureBounds<D>::get_2D_cross_coefficients(Eigen::Matrix<float,D,4> &control_points)
{
...
template <int D>
Eigen::Vector4d ThirdOrderCurvatureBounds<D>::get_3D_cross_coefficients(Eigen::Matrix<float,D,4> &control_points)
{
    float p0x = control_points(0,0);
    float p0y = control_points(1,0);
...
template <int D>
float ThirdOrderCurvatureBounds<D>::calculate_cross_term_magnitude(float &t, Eigen::Matrix<float,D,4> &control_points, float &scale_factor)
{
    DerivativeEvaluator<D> d_dt_eval{};
