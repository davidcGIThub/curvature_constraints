...
class ObstacleConstraints(object):
    ...
    def __init__(self, dimension):
        ND_POINTER_FLOATS = np.ctypeslib.ndpointer(dtype=np.float32, ndim=1,flags="C")
        self._dimension = dimension
        if dimension == 2:
            lib.ObstacleConstraints_2.argtypes = [ctypes.c_void_p]
            lib.ObstacleConstraints_2.restype = ctypes.c_void_p
            lib.checkIfObstacleCollides_2.argtypes = [ctypes.c_void_p, ND_POINTER_FLOATS, ctypes.c_int, 
                ctypes.c_float, ND_POINTER_FLOATS]
            lib.checkIfObstacleCollides_2.restype = ctypes.c_bool
            lib.getObstacleDistanceToSpline_2.argtypes = [ctypes.c_void_p,ND_POINTER_FLOATS, ctypes.c_int, 
                ctypes.c_float, ND_POINTER_FLOATS]
            lib.getObstacleDistanceToSpline_2.restype = ctypes.c_float
            ...
            lib.checkIfObstacleCollides_3.argtypes = [ND_POINTER_FLOATS, ctypes.c_int, 
                ctypes.c_float, ND_POINTER_FLOATS]
            lib.checkIfObstacleCollides_3.restype = ctypes.c_bool
            lib.getObstacleDistanceToSpline_3.argtypes = [ND_POINTER_FLOATS, ctypes.c_int, 
                ctypes.c_float, ND_POINTER_FLOATS]
            lib.getObstacleDistanceToSpline_3.restype = ctypes.c_float
    ...
    def getObstacleDistanceToSpline(self, cont_pts, obstacle_radius, obstacle_center):
        ...
        obstacle_center_array = obstacle_center.flatten().astype('float32')
