...
TEST(WaypointConstraintTests, VelocitiesCase1)
{
    ...
    float control_points[] = {3, 0, 9, 5, 7, 8, 0, 1,
                               1, 6, 2, 2, 1, 4, 1, 4};
    int num_control_points = 8;
    float scale_factor = 1;
    float true_constraints[] = {-4, -6.5, -0.5, -4};
    float desired_velocities[] = {7, 3, 1, 4};
    float* constraints = waypoint_const.velocity_at_waypoints_constraints(control_points, num_control_points,
...
TEST(WaypointConstraintTests, VelocitiesCase2)
{
    ...
    float control_points[] = {0, 9, 0, 8, 5, 8, 6, 7,
                               1, 5, 1, 6, 5, 4, 2, 7,
                               5, 4, 5, 6, 8, 7, 5, 9};
    int num_control_points = 8;
    float scale_factor = 2;
    float true_constraints[] = {-9, -0.25, -6, -5.25, -8, -7.5};
    float desired_velocities[] = {9, 0, 6, 6, 8, 8};
    float* constraints = waypoint_const.velocity_at_waypoints_constraints(control_points, num_control_points,
                        scale_factor, desired_velocities);
