...
TEST(MDMAlgorithmTests, MDMClassRandomCase1)
{
    ...
    Eigen::MatrixXf points(dimension,num_points);
    points << 8, 5, 13, 10,  8, 14,
             13, 9, 10, 10, 12, 10;
    int max_iter = 5000;
    unsigned int init_index = 1;
    float true_min_norm = 10.295630140987;
    float tolerance = 0.000001;
    // auto start = std::chrono::system_clock::now();
    MDMAlgorithmClass<dimension> mdm{};
    float min_norm = mdm.min_norm(points,num_points, max_iter, init_index, tolerance);
    // auto end = std::chrono::system_clock::now();
    // std::chrono::duration<float> elapsed_seconds = end-start;
    // std::cout << "elapsed time class: " << elapsed_seconds.count() << "s" << std::endl;
    float error_tolerance = 0.00000001;
...
TEST(MDMAlgorithmTests, MDMRandomCase2)
{
    ...
    int max_iter = 5000;
    unsigned int init_index = 1;
    float true_min_norm = 10.289915108550531;
    float tolerance = 0.000001;
    MDMAlgorithmClass<dimension> mdm{};
    float min_norm = mdm.min_norm(points,num_points, max_iter, init_index, tolerance);
    float error_tolerance = 0.00000001;
...
TEST(MDMAlgorithmTests, MDMStraightLine)
{
    ...
    int max_iter = 5000;
    unsigned int init_index = 1;
    float true_min_norm = 1.4142135623730951;
    float tolerance = 0.000001;
    MDMAlgorithmClass<dimension> mdm{};
    float min_norm = mdm.min_norm(points,num_points, max_iter, init_index, tolerance);
    float error_tolerance = 0.00000001;
...
TEST(MDMAlgorithmTests, MDMStraightLine2)
{
    ...
    int max_iter = 5000;
    unsigned int init_index = 1;
    float true_min_norm = 4.949747468305833;
    float tolerance = 0.000001;
    MDMAlgorithmClass<dimension> mdm{};
    float min_norm = mdm.min_norm(points,num_points, max_iter, init_index, tolerance);
    float error_tolerance = 0.00000001;
...
TEST(MDMAlgorithmTests, MDMSamePoints)
{
    ...
    float tolerance = 0.000001;
    unsigned int init_index = 1;
    float true_min_norm = 7.810249675906654;
    MDMAlgorithmClass<dimension> mdm{};
    float min_norm = mdm.min_norm(points,num_points, max_iter, init_index, tolerance);
    float error_tolerance = 0.00000001;
    EXPECT_NEAR(true_min_norm, min_norm, error_tolerance);
...
TEST(MDMAlgorithmTests, RandomCase3)
{
    ...
    float tolerance = 0.000001;
    unsigned int init_index = 1;
    float true_min_norm = 10.261953630166738;
    MDMAlgorithmClass<dimension> mdm{};
    float min_norm = mdm.min_norm(points,num_points, max_iter, init_index, tolerance);
    float error_tolerance = 0.00000001;
    EXPECT_NEAR(true_min_norm, min_norm, error_tolerance);
...
TEST(MDMAlgorithmTests, RandomCase3D_1)
{
    ...
    float tolerance = 0.000001;
    unsigned int init_index = 1;
    float true_min_norm = 11.671087598447691;
    MDMAlgorithmClass<dimension> mdm{};
    float min_norm = mdm.min_norm(points,num_points, max_iter, init_index, tolerance);
    float error_tolerance = 0.00000001;
    EXPECT_NEAR(true_min_norm, min_norm, error_tolerance);
