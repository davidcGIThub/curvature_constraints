...
TEST(ThirdOrderCurvatureTest, RandomNormalSpline)
{
    ...
    float curvature_bound = c_eval.evaluate_interval_curvature_bound(control_points);
...
TEST(ThirdOrderCurvatureTest, SplineCurvatureBound)
{
    ...
    float max_curvature = c_eval.get_spline_curvature_bound(control_points, num_control_points);
    float tolerance = 0.000001;
...
TEST(ThirdOrderCurvatureTest, SplineIntervalCurvatureBounds)
{
    ...
    float control_points[] = {-0.96055144, -0.04452866, 1.13866608, 2.49667343, 
        3.80204877, 4.76675134, 5.11662433,  4.76675134, -0.13352168, 0.06676084,
        -0.13352168, -0.58215741, -0.93804997, -0.84450962, -0.10254957,  1.25470791};
    Eigen::VectorXf curvature_bounds = c_eval.get_interval_curvature_bounds(control_points, num_control_points);
    Eigen::Matrix<float,5,1> true_curvature_bounds;
