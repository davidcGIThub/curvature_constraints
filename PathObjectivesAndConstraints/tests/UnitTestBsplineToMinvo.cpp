...
{
    Eigen::Matrix<float, 2,2> bspline_control_points;
    bspline_control_points << 0, 2,
                              2,-1;
    Eigen::Matrix<float, 2,2> true_minvo_control_points;
    true_minvo_control_points << 0, 2,
                                 2,-1;
    Eigen::Matrix<float, 2,2> minvo_control_points;
...
{
    Eigen::Matrix<float, 2, 3> bspline_control_points;
    bspline_control_points << 3, 0, 9,
                              1, 6, 2;
    Eigen::Matrix<float, 2,3> true_minvo_control_points;
    true_minvo_control_points << 1.26794922, 0.99999996, 4.73205078,
                                 3.46132487, 5.24999997, 4.03867513;
    Eigen::Matrix<float, 2,3> minvo_control_points;
    BsplineToMinvo<2> converter{};
...
{
    Eigen::Matrix<float, 2, 5> bspline_control_points;
    bspline_control_points << 9, 5, 7, 8, 0,
                              2, 2, 1, 4, 4;
    Eigen::Matrix<float, 2, 5> true_minvo_control_points;
    ...
    Eigen::Matrix<float, 2, 5> minvo_control_points;
    BsplineToMinvo<2> converter{};
...
{
    Eigen::Matrix<float, 2, 6> bspline_control_points;
    bspline_control_points << 3, 0, 9, 5, 7, 8,
                              1, 6, 2, 2, 1, 4;
    Eigen::Matrix<float, 2, 6> true_minvo_control_points;
    ...
    Eigen::Matrix<float, 2, 6> minvo_control_points;
    BsplineToMinvo<2> converter{};
...
{
    Eigen::Matrix<float, 2, 7> bspline_control_points;
    bspline_control_points << 1, 5, 1, 6, 5, 4, 2,
                              5, 4, 5, 6, 8, 7, 5;
    Eigen::Matrix<float, 2, 7> true_minvo_control_points;
    ...
    Eigen::Matrix<float, 2, 7> minvo_control_points;
    BsplineToMinvo<2> converter{};
...
{
    Eigen::Matrix<float, 2, 8> bspline_control_points;
    bspline_control_points << 3, 0, 9, 5, 7, 8, 0, 1,
                              1, 6, 2, 2, 1, 4, 1, 4;
    Eigen::Matrix<float, 2, 8> true_minvo_control_points;
    ...
    Eigen::Matrix<float, 2, 8> minvo_control_points;
    BsplineToMinvo<2> converter{};
...
{
    Eigen::Matrix<float, 3, 4> bspline_control_points;
    bspline_control_points << 9, 0, 8, 5,
                              1, 5, 1, 6,
                              5, 4, 5, 6;
    Eigen::Matrix<float, 3, 4> true_minvo_control_points;
    ...
    Eigen::Matrix<float, 3,4> minvo_control_points;
