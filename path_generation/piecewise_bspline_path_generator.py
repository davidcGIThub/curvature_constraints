...
class PiecwisePathGenerator:
    ...
    def generate_trajectory(self, waypoints,velocities, max_velocity, max_curvature):
        ...
        max_velocity_and_acceleration_constraint = \
            self.__create_maximum_velocity_and_acceleration_constraint(max_velocity, max_acceleration)
        ...
        result = minimize(
            ...
            constraints=(waypoint_constraint, velocity_constraint, \
                max_velocity_and_acceleration_constraint, curvature_constraint), 
    ...
    def __create_maximum_velocity_and_acceleration_constraint(self, max_velocity, max_acceleration):
        ...
        lower_bound = -np.inf
        upper_bound = 0
        max_velocity_and_acceleration_constraint = NonlinearConstraint(maximum_velocity_and_acceleration_constraint_function, \
             lb = lower_bound, ub= upper_bound)
        return max_velocity_and_acceleration_constraint       
    ...
    def create_safe_corridor_constraint(self, center, width, height):
