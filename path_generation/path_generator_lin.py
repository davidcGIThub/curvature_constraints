...
class PathGenerator:
    ...
    def __create_objective_variable_bounds(self):
        lower_bounds = np.zeros(self._num_control_points*self._dimension ) - np.inf
        upper_bounds = np.zeros(self._num_control_points*self._dimension ) + np.inf
    ...
    def __minimize_acceleration_and_distance_objective_function(self, variables):
        ...
        return 3*sum_of_acceleration_integrals + sum_of_distance_integrals
